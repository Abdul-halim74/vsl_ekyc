...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.9.3/table_data_tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Sep 2020 06:12:26 GMT -->
<head>
            ...
            <div class="row">
                ...
                <div class="ibox ">
                    ...
                    <tr>
                        ...
                        <th>Address img file loc</th>
                        <th>Nid front img loc</th>
                        <th>Nid back img file loc</th>
                        <th>User img file loc</th>
                    ...
                    <tbody>
                        <?php
                            ...
                            $select_data="SELECT * FROM `userkyc` ";
                            $query_data=mysqli_query($connect,$select_data);
                    ...
                    <tr class="gradeX">
                        <td><?php echo $fetch_data['sl']; ?></td>
                        <td><?php echo $fetch_data['user_address']; ?></td>
                        <td><?php echo $fetch_data['dob']; ?></td>
                        <td><?php echo $fetch_data['user_gender']; ?></td>
                        <td><?php echo $fetch_data['user_email']; ?></td>
                        <td><?php echo $fetch_data['user_phn']; ?></td>
                        <td><?php echo $fetch_data['user_nid']; ?></td>
                        <td><?php echo $fetch_data['status']; ?></td>
                        <td><img width="100px" height="100px" src="<?php echo $fetch_data['address_img_file_loc']; ?>" alt="Not found img"></td>

                        <td><img width="100px" height="100px" src="<?php echo $fetch_data['nid_front_img_file_loc']; ?>" alt="Not found img"></td>

                        <td><img width="100px" height="100px" src="<?php echo $fetch_data['nid_back_img_file_loc']; ?>" alt="Not found img"></td>

                        <td><img width="100px" height="100px" src="<?php echo $fetch_data['user_img_file_loc']; ?>" alt="Not found img"></td>
...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.9.3/table_data_tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Sep 2020 06:12:27 GMT -->
</html>
